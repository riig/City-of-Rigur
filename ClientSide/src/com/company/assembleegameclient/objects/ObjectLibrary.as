...
import customs.npc.bonesthebutcher.BonesTheButcher;
...
public class ObjectLibrary {
    ...
    public static const TYPE_MAP:Object = {
        ...
        "BonesTheButcher":BonesTheButcher
    };
    ...
    public static function getRedrawnTextureFromType(_arg1:int, _arg2:int, _arg3:Boolean, _arg4:Boolean = true, _arg5:Number = 5) : BitmapData
    {
        ...
        //UT
        if(_local8 == null && _local9.hasOwnProperty("UTGlow")) //add <UHGlow/> to xml same for other
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,9055202,_arg4,_arg5);
        }
        //UH
        if(_local8 == null && _local9.hasOwnProperty("UHGlow"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0x9E9859,_arg4,_arg5);
        }
        //ST
        if(_local8 == null && _local9.hasOwnProperty("@setType")) //all sts should have this auto
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0xFF9900,_arg4,_arg5);
        }
        //UPGRADED T12+
        if(_local8 == null && _local9.hasOwnProperty("UpgradedGlow"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0xF7E26B,_arg4,_arg5);
        }
        //*CUSTOM TIERS*
        if(_local8 == null && _local9.hasOwnProperty("CrystalGlow")) //CRYSTAL ITEMS
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0xC6CEF8,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("BloodGlow")) //BLOOD ITEMS
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0xDB0000,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("SideQuestGlow")) //SIDEQUEST ITEMS
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0xE1DBFF,_arg4,_arg5);
        }
        //ADMIN ITEMS
        if(_local8 == null && _local9.hasOwnProperty("AdminGlow"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0xFFD700,_arg4,_arg5);
        }
