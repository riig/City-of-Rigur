...
public class EquipmentToolTip extends ToolTip {
    ...
    private function addTitle():void {
        var _Color:int = ObjectLibrary.getTierColoring(this.objectType); //var _local1:int = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFFFF : 16549442);
        this.titleText = new TextFieldDisplayConcrete().setSize(16).setColor(_Color).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) - 30)).setWordWrap(true);
    ...
    private function addDescriptionText():void {
        var _Color:int = ObjectLibrary.getTierColoring(this.objectType); //0xB3B3B3
        this.descText = new TextFieldDisplayConcrete().setSize(14).setColor(_Color).setTextWidth(MAX_WIDTH).setWordWrap(true);
