...
public class ChatListItemFactory {
    ...
    private function processName():String {
        ...
        return ((("(" + this.message.numStars.toString() + ") " + "<" + _local1) + ">")); // (stars) <name> "message"
    }
    ...
    private function getBitmapData(_arg1:StringBuilder, _arg2:uint):BitmapData {
        ...
        var _local5:BitmapData = this.factory.make(_arg1, 13, _arg2, true, IDENTITY_MATRIX, true); //text size
