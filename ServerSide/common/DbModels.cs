...
namespace common
{
    ...
    public class DbAccount : RedisObject
    {
        ...
        {
            get { return GetValue<int>("accountLvl"); }
            set { SetValue<int>("accountLvl", value); }
        }
        public int AccountLXP
        {
            get { return GetValue<int>("accountLXP"); }
            set { SetValue<int>("accountLXP", value); }
        }

        public int CampaignPoints
        {
            get { return GetValue<int>("campaignPoints"); }
            set { SetValue<int>("campaignPoints", value); }
        }
