    ...
    partial class BehaviorDb
    {
        private _ Mountain = () => Behav()
            ...
            .Init("Elder Medusa",
                ...
                new Threshold(1,
                    new ItemLoot("Elder Medusa Snake Staff", 1),
                    new ItemLoot("Elder Medusa Snake Spell", 1),
                    new ItemLoot("Elder Medusa Snake Robe", 1),
                    new ItemLoot("Elder Medusa Snake Ring", 1)
                    )
            )
            .Init("Ent God",
                new State(
