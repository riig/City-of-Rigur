...
namespace wServer.realm.entities
{
    partial class Player
    {
            ...
            foreach (var eff in item.ActivateEffects)
            {
                switch (eff.Effect)
                {
                    ...
                    case ActivateEffects.HealingGrenade:
                        ...
                        break;
                    case ActivateEffects.SpawnFoolsPrism:
                        AESpawnFoolsPrism(time, item, target, eff);
                        break;
                    default:
        ...
        private void AELTBoost(RealmTime time, Item item, Position target, ActivateEffect eff)
        {
            ...
            //UpdateAccountXP(Client.Player, "Used a Loot Tier Boost!", 25);
        }
        ...
        private void AELDBoost(RealmTime time, Item item, Position target, ActivateEffect eff)
        {
            ...
            //UpdateAccountXP(Client.Player, "Used a Loot Drop Boost!", 25);
        }
        ...
        private void AEXPBoost(RealmTime time, Item item, Position target, ActivateEffect eff)
        {
            ...
            //UpdateAccountXP(Client.Player, "Used a Level XP Boost!", 25);
        }

        private void AEBackpack(RealmTime time, Item item, Position target, ActivateEffect eff)
        {
            HasBackpack = true;
            UpdateAccountXP(Client.Player, "Used a Backpack!", 25);
        }
        ...
        private void AEDye(RealmTime time, Item item, Position target, ActivateEffect eff)
        {
            ...
            UpdateAccountXP(Client.Player, "Used a Dye/Cloth!", 25);
        }
        ...
        private void AECreate(RealmTime time, Item item, Position target, ActivateEffect eff)
        {
            ...
            UpdateAccountXP(Client.Player, "Used a Key!", 25);
        }
        ...
        private void AEIncrementStat(RealmTime time, Item item, Position target, ActivateEffect eff)
        {
            ...
            UpdateAccountXP(Client.Player, "Used a Stat Potion!", 25);
        }
        ...
        private void AESpawnFoolsPrism(RealmTime time, Item item, Position target, ActivateEffect eff)
        {
            Entity entity;
            entity = Entity.Resolve(Manager, 0x69ac);
            entity.Move(target.X, target.Y);
            Owner.EnterWorld(entity);
            foreach (var i in Owner.Players.Values)
            { 
            i.Owner.Timers.Add(new WorldTimer(5000, (w, t) =>
            {
                w.LeaveWorld(entity);
            }));
            }
